        ...
        <div className="text-xl ">Enter your email to sign in to your account</div>
				...
				<div className="bg-white p-8 rounded-xl shadow-lg border border-black/10 w-110 ">
					...
					<div className="grid grid-cols-2 gap-4 mb-6">
						<button className="flex gap-4  items-center justify-center border p-3 border-black/10  rounded-md cursor-pointer">
							{/* Google */}
					...
					<Button variant="outline" className="w-full  cursor-pointer mt-4">
						Use a Demo Account
					</Button>
				</div>
